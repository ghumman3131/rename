...
import com.example.mohitpal.rentme.core.users.getall.GetUsersContract;
import com.example.mohitpal.rentme.core.users.getall.GetUsersPresenter;
import com.example.mohitpal.rentme.models.User;
import com.example.mohitpal.rentme.ui.activities.ChatActivity;
import com.example.mohitpal.rentme.ui.adapters.UserListingRecyclerAdapter;
import com.example.mohitpal.rentme.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ...
        System.out.println(" user id is "+ mUserListingRecyclerAdapter.getUser(position).uid);
